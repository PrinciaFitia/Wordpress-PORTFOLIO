...
class Solace_Extra_Nav_Menu extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'layout!' => 'dropdown',
					'pointer' => [ 'underline', 'overline', 'double-line', 'none' ],
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} nav.elementor-nav-menu--dropdown a, {{WRAPPER}} nav.elementor-nav-menu--dropdown svg, {{WRAPPER}} .elementor-nav-menu--main .elementor-item, {{WRAPPER}} .elementor-nav-menu--main svg, {{WRAPPER}} .elementor-nav-menu--main .sub-menu a, {{WRAPPER}} .elementor-nav-menu--main .sub-menu svg' => 'color: {{VALUE}}; fill: {{VALUE}};',
				],
			]
		);
	...
	public function add_span_to_menu_items( $item_output, $item, $depth, $args ) {
		...
		if ( in_array( 'menu-item-has-children', $item->classes ) ) {
			...
			$icon_markup = '<span class="sub-arrow"><svg class="e-font-icon-svg e-fas-caret-down" viewBox="0 0 320 512" xmlns="http://www.w3.org/2000/svg"><path d="M31.3 192h257.3c17.8 0 26.7 21.5 14.1 34.1L174.1 354.8c-7.8 7.8-20.5 7.8-28.3 0L17.2 226.1C4.6 213.5 13.5 192 31.3 192z"></path></svg></span>';
