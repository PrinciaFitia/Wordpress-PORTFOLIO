...
wp_localize_script(
	...
	array(
		...
		'builderStatusData' => array(
			'status'                          => oblixar_theme()->getPluginsManager()->getPluginState( oblixar_get_builder_plugin_slug() ),
			'install_url'                     => oblixar_theme()->getPluginsManager()->getInstallLink( oblixar_get_builder_plugin_slug() ),
			'activate_url'                    => oblixar_theme()->getPluginsManager()->getActivationLink( oblixar_get_builder_plugin_slug() ),
			'slug'                            => oblixar_get_builder_plugin_slug(),
...
<div class="oblixar-notice-dont-show-container">
	<button class="button-link oblixar-dont-show-notice">
		<?php Translations::escHtmlE( 'dont_show_anymore' ); ?>
	</button>
</div>

<div class="oblixar-admin-notice-spacer">
	<div class="oblixar-admin-big-notice--container">
		<div class="content-holder">
			<div class="messages-area">
				<div class="title-holder">
					<h1><?php Translations::escHtmlE( 'would_you_like_to_install_front_page', oblixar_theme()->getName() ); ?></h1>
					<p><?php Translations::escHtmlE( 'theme_description', oblixar_theme()->getName() ); ?></p>
				</div>

				<ul>
					<li>
						<img src="<?php echo oblixar_theme()->getListMarkerUrl(); ?>" alt="">
			...
			<div class="front-page-preview">
				<img src="<?php echo esc_url( oblixar_theme()->getFrontPagePreview() ); ?>"/>
			</div>
		</div>
	</div>
</div>
