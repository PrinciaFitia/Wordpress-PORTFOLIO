...
$oblixar_theme_divider_style = array(
...
$oblixar_theme_action_button           = __( 'Explore now', 'oblixar' );
$oblixar_theme_action_button_secondary = __( 'Contact us', 'oblixar' );

$oblixar_theme_click_pen_to_edit_title = __( 'Uncover beauty in the unknown.', 'oblixar' );
$oblixar_lorem_ipsum                   = 'Lorem ipsum dolor sit amet, at mei dolore tritani repudiandae. In his nemore temporibus consequuntur, vim ad prima vivendum consetetur.';


return array(
	'default_icon'                      => $oblixar_theme_svg_icons['fort-awesome'],
	'icons'                             => $oblixar_theme_svg_icons,
	'divider_style'                     => $oblixar_theme_divider_style,
	'lorem_ipsum'                       => $oblixar_lorem_ipsum,
	'edit_this_text_in_customizer'      => $oblixar_theme_click_pen_to_edit_title,
	'gradients'                         => $oblixar_gradients,
	...
	'front-header'                      => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $oblixar_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $oblixar_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title'        => array(
			'show'  => true,
			'value' => $oblixar_theme_click_pen_to_edit_title,
			'style' => array(
				'descendants' => array(
					'text' => array(
						'textAlign' => 'left', 
							...
							'image'     => array(
								array(
									'source'     => array(
										...
										'gradient' => $oblixar_gradients['night_fade'],
									),
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $oblixar_theme_svg_icons['facebook-square-full'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $oblixar_theme_svg_icons['twitter-x'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $oblixar_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $oblixar_theme_svg_icons['vimeo'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $oblixar_theme_svg_icons['map-marker'],
						'text'       => '123, Main Street, City, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $oblixar_theme_svg_icons['phone'],
						'text'       => '+1 234 567 890',
						'link_value' => 'tel:+1 234 567 890',
						'index'      => 0,
					),
					array(
						'icon'       => $oblixar_theme_svg_icons['envelope'],
	...
	'header'                            => array(
					...
					'outer' => array(
						'background' => array(
							...
							'image'     => array(
								array(
									'source'     => array(
										'url'      => get_template_directory_uri() . '/resources/images/background-inner-image.jpg',
										'gradient' => $oblixar_gradients['night_fade'],
									),
									'position'   => 'center center',
									'size'       => 'cover',
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					...
					array(
						'icon'       => $oblixar_theme_svg_icons['whatsapp-square'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $oblixar_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $oblixar_theme_svg_icons['phone-square'],
	...
	'blog_post_thumb_placeholder_color' => 'rgba(165, 165, 141, 0.1)',
	...
	'front_page_designs'                => array(
		array(
			'name'    => __( 'Modern', 'oblixar' ),
			'index'   => 1,
			'preview' => 'front-page-1.jpg',
		),

		array(
			'name'    => __( 'Fullscreen', 'oblixar' ),
			'index'   => 2,
			'preview' => 'front-page-2.jpg',
		),

		array(
			'name'    => __( 'Classic', 'oblixar' ),
			'index'   => 3,
