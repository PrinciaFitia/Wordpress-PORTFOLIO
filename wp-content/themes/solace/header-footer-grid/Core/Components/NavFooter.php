...
class NavFooter extends Abstract_Component {
	...
	public function init() {
		$this->set_property( 'label', __( 'Footer Menu', 'solace' ) );
	...
	public function add_settings() {
		...
		SettingsManager::get_instance()->add(
			[
				...
				'options'           => [
					'button_class' => 'nv-top-bar-menu-shortcut',
					'icon_class'   => 'menu',
					'button_text'  => __( 'Footer Menu', 'solace' ),
					'shortcut'     => true,
				],
				'section'           => $this->section,
			]
		...
		SettingsManager::get_instance()->add(
			[
				...
				'section'            => $this->section,
				'conditional_header' => true,self::FONT_FAMILY,
			]
		);
		...
		if ( $get_base_font_theme_mod === Mods::get_alternative_mod_default( Config::MODS_FONT_GENERAL ) ) {
			...
			$default_menu_font_family = get_theme_mod( 'footer-menu_font_family', $get_base_font_theme_mod );
		}
		...
		if ( $get_type_face_base_theme_mod === Mods::get_alternative_mod_default( Config::MODS_TYPEFACE_GENERAL ) ) {
			...
			$default_menu_typeface = get_theme_mod( 'footer-menu_typeface_general', $get_type_face_base_theme_mod );
		}
